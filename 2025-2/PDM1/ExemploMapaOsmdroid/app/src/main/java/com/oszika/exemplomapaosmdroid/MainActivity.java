package com.oszika.exemplomapaosmdroid;
...
//    -10.1987632,-48.3129125
    ...
    private void inicializarMapa() {
        if (map != null) {
            ...
            GeoPoint palmas = new GeoPoint(-10.1987632, -48.3129125);
            ...
            marker.setTitle("Palmas IFTO");
            marker.setIcon(ContextCompat.getDrawable(this, R.drawable.sol));
