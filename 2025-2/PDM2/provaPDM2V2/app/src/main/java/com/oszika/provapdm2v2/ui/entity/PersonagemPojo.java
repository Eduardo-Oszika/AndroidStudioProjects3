...
public class PersonagemPojo {
     ...
     *
     */
    public PersonagemPojo() {
    }
    public PersonagemPojo(Integer id, List<String> films, List<String> shortFilms, List<String> tvShows, List<String> videoGames, List<String> parkAttractions, List<Object> allies, List<Object> enemies, String name, String imageUrl, String url) {
        super();
        this.id = id;
        this.films = films;
